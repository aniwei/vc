...
import { Canvas, Paint, Path } from 'bindings'
...
export class Painting {
  ...
  static paintBorderWithIrregular(canvas: Canvas, shape: Path, side: BorderSide): void {
  ...
  static paintWithImage = paintWithImage
}
